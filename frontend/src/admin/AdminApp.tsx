    ...
    <Router>
      <div className="flex min-h-screen">
        ...
        <main className="flex-1 p-6 bg-gray-100">
          <Routes>
            <Route path="/login" element={isLoggedIn ? <Navigate to="/admin/dashboard" /> : <LoginPage />} />
            <Route path="/admin/dashboard" element={isLoggedIn ? <DashboardPage /> : <Navigate to="/login" replace />} />
            <Route path="/admin/orders" element={isLoggedIn ? <OrdersPage /> : <Navigate to="/login" replace />} />
            <Route path="/admin/employees" element={isLoggedIn ? <EmployeesPage /> : <Navigate to="/login" replace />} />
            <Route path="/admin/menus" element={isLoggedIn ? <MenusPage /> : <Navigate to="/login" replace />} />
